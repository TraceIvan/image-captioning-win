...
__C.DATA_LOADER.TRAIN_ATT_FEATS = './mscoco/feature/up_down_10_100/train'

__C.DATA_LOADER.VAL_GV_FEAT = ''

__C.DATA_LOADER.VAL_ATT_FEATS = './mscoco/feature/up_down_10_100/val'

__C.DATA_LOADER.TEST_GV_FEAT = ''

__C.DATA_LOADER.TEST_ATT_FEATS = './mscoco/feature/up_down_10_100/test'

__C.DATA_LOADER.TRAIN_ID = './mscoco/txt/coco_train_image_id.txt'

__C.DATA_LOADER.VAL_ID = './mscoco/txt/coco_val_image_id.txt'

__C.DATA_LOADER.TEST_ID = './mscoco/txt/coco_test_image_id.txt'

__C.DATA_LOADER.INPUT_SEQ_PATH = './mscoco/sent/coco_train_input.pkl'

__C.DATA_LOADER.TARGET_SEQ_PATH = './mscoco/sent/coco_train_target.pkl'
...
__C.SCORER.GT_PATH = './mscoco/misc/coco_train_gts.pkl'

__C.SCORER.CIDER_CACHED = './mscoco/misc/coco_train_cider.pkl'
...
__C.INFERENCE.VOCAB = './mscoco/txt/coco_vocabulary.txt'
...
__C.INFERENCE.VAL_ANNFILE = './mscoco/misc/captions_val5k.json'

__C.INFERENCE.TEST_ANNFILE = './mscoco/misc/captions_test5k.json'

__C.INFERENCE.BEAM_SIZE = 1

__C.INFERENCE.GREEDY_DECODE = True # Greedy decode or sample decode

__C.INFERENCE.COCO_PATH = 'D:\\python_projects\\image-captioning-master\\coco-caption'
...
__C.TEMP_DIR = 'D:\\python_projects\\image-captioning-master\\data\\temp'
